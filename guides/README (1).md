...
{% hint style="info" %}
계정 생성 시 기본적으로 "Guest" 권한을 갖게 되고 TestTracker의 사용자 권한 정책에 의해 제한적인 서비스 이용이 가능합니다. 이에 대한 자세한 사항은 "[멤버 구성 편집 > User Role 설정](user-guides/undefined-6.md#user-role)" 설명을 참고 바랍니다.
{% endhint %}
