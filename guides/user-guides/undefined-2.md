...
<mark style="color:blue;">**Test Schedule**</mark> : 예약된 시각에 자동으로 테스트가 실행되도록 이미 설정된 테스트들에 대해 테스트 타입, 예약된 실행 시각, 테스트 옵션 등을 확인할 수 있습니다. Schedule job 설정 방법은 "[테스트 실행 (예약)](undefined-5.md)"을 참고해 주시기 바랍니다.
...
<mark style="color:blue;">**Working Directory**</mark> : 테스트 실행에 필요한 script 및 data file들을 관리할 수 있습니다. 권한이 있는 사용자에 의해 파일 삭제가 가능하고, data file에 한 해 업로드를 지원합니다. Test script file에 대한 생성 또는 업로드는 각 [테스트 구성](undefined-3.md) 페이지에서 지원합니다.
